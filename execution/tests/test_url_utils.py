...
class TestUrlUtils(unittest.TestCase):
    ...
    def test_resolve_company_name_from_subdomain(self):
    ...
    def test_extract_requisition_id_and_deduplication(self):
    ...
    def test_sanitize_multi_location(self):
    ...
    def test_detect_ats_sources(self):
